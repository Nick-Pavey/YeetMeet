...
function getUserPID() {
    var e, t = "https://r6tab.com/api/player.php?p_id=" + document.getElementById("Userpidtxt").value, n = new XMLHttpRequest, s = [];
    n.onload = function() {
        console.log(t),
    ...
    n.open("GET", t),
    n.send()
}async function runSearches(){var e=document.getElementById("numofsearches").value,t=document.getElementById("pauseinms").value;for(console.log(e),i=0;i<e;i++)getUserPID(),await sleep(t)}function sleep(e){return new Promise(t=>setTimeout(t,e))}function startnew(){document.getElementById("newgamemodal").hidden=!1}
